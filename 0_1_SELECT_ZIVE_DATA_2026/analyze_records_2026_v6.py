...
https://chatgpt.com/c/69b5050c-ddbc-8392-81b3-662acd2c8441
...
def main() -> None:
    ...
    # Išvesti konfigo informaciją, kad būtų matyti, ar teisingai įkeliamas ir pritaikomas
    print(f"Denoising config loaded from: {args.cfg_denoising}")
    print(f"Model directory: {args.model_dir}")
    print(f"Motions enabled: {cfg_denoising.motions.enabled}")
