...
def write_output_workbook(
    ...
    *,
    ...
    ws_marks["B2"] = "Pažymėti tag = 1111 , kurie tinka mokymui (pradinis x)"
    ws_marks["B4"] = "Pažymėti tag = 2222,  kokybė nebloga, tačiau ant ribos, gal labiau  tinka triukšmų testavimui (pradinis xx)"
