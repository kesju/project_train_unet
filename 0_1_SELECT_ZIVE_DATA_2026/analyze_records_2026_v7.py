...
def write_output_workbook(
    ...
    *,
    ...
    marks_text = {
        ...
        "B5":  "tag = 2222",
        "C5":  "Kokybė nebloga, tačiau ant ribos, gal labiau tinka triukšmų testavimui",
        "B6":  "tag = 22220",
        "C6":  "Pretendentas testavimui, bus patvirtinta po anotavimo",
        "B8":  "tag = 3333",
        "C8":  "Gana daug triukšmų, gali tikti triukšmų testavimui",
        "B9":  "tag = 33330",
        "C9":  "Gana daug triukšmų, gali pretenduoti triukšmų testavimui, bus patvirtinta po anotavimo",
        "B11": "tag = 5555",
        "C11": "Ypatingi, 'keisti' atvejai",
        "B13": "tag = 9999",
