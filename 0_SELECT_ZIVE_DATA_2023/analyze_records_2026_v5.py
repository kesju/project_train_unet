...
def summarize_record(
    ...
    *,
    ...
    h_n = int(h_counts_clean.get("N", 0))
    h_s = int(h_counts_clean.get("S", 0))
    h_v = int(h_counts_clean.get("V", 0))
...
def main() -> int:
    ...
    if in_path.is_file() and in_path.suffix.lower() == ".zip":
        ...
        with zipfile.ZipFile(in_path, "r") as zf:
            ...
            for jm in json_members:
                ...
                basename = PurePosixPath(data_member).name
    ...
    for c in ["dur_s", "h_nz_frac", "ml_nz_frac"]:
...
python3 analyze_records_2026_v3_IGNO.py /home/kesju/DI/2025_ZIVEO/PROJECT_TRAIN_UNET/0_COLLECT_ZIVE_DATA/DUOM_2026_01_27/records_igno_2026 \
--fs 200 --out records_summary_2026_v3_IGNO.csv
"""