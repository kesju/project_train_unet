...
# PRDINIŲ PARAMETRŲ NUSKAITYMAS IŠ KOMANDINĖS EILUTĖS - jei norime paleisti šį skriptą tiesiogiai
...
# ap.add_argument("--exclude_file", type=Path, required=True, help="Directory containing ECG .npy files and corresponding JSON metadata")    
